...
class ThaiBahtFormatSpec extends Specification {
	...
	def 'test method format(BigDecimal) should return set valid String'() {	
		...
		format.format(-1257.5463) == 'ลบหนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
		format.format(-1257.55) == 'ลบหนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
		format.format(1257.5463) == 'หนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
		format.format(1257.55) == 'หนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
	...
	def 'test static method convert(BigDecimal) should return set valid String'() {	
		...
		ThaiBahtFormat.convert(-1257.5463) == 'ลบหนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
		ThaiBahtFormat.convert(-1257.55) == 'ลบหนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
		ThaiBahtFormat.convert(1257.5463) == 'หนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
		ThaiBahtFormat.convert(1257.55) == 'หนึ่งพันสองร้อยห้าสิบเจ็ดบาทห้าสิบห้าสตางค์ถ้วน'
